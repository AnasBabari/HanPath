...
export const ACHIEVEMENTS: Achievement[] = [
  { id: 'first-lesson', title: 'First Steps', desc: 'Complete your first lesson', icon: '🎯', check: s => (s.completedLessons?.length || 0) >= 1 },
  { id: 'five-lessons', title: 'Getting Started', desc: 'Complete 5 lessons', icon: '📚', check: s => (s.completedLessons?.length || 0) >= 5 },
  { id: 'ten-lessons', title: 'Dedicated Learner', desc: 'Complete 10 lessons', icon: '🌟', check: s => (s.completedLessons?.length || 0) >= 10 },
  { id: 'twenty-lessons', title: 'Rising Scholar', desc: 'Complete 20 lessons', icon: '🏆', check: s => (s.completedLessons?.length || 0) >= 20 },
  { id: 'fifty-lessons', title: 'Knowledge Seeker', desc: 'Complete 50 lessons', icon: '👑', check: s => (s.completedLessons?.length || 0) >= 50 },
